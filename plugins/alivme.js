...
ezra(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    const fullImageUrl = "https://files.catbox.moe/g7qjxj.png"; // Full image URL
    const smallThumbnailUrl = "https://files.catbox.moe/g7qjxj.png"; // Small thumbnail URL
    const randomAudio = "https://files.catbox.moe/wdap4t.mp3"; // Voice note URL
    const sourceUrl = "https://whatsapp.com/channel/0029Vb5zdsiA89MrLd1hAk2Q"; // Channel link
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          externalAdReply: {
            title: `💦 Message from: ${contactName}\n🔥DIIGITEX_XMD Alive🔥 visit ${conf.SITE} for more`, // Your contact in WhatsApp status format
